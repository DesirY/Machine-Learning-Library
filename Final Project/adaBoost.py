...
# for i in range(20):
#     n_etm = 100+i*10
#     n_range.append(n_etm)
#     clf = AdaBoostClassifier(n_estimators=n_etm)
#     scores = cross_val_score(clf, X, y, cv=10)
#     score_lst.append(scores.mean())
#     print(scores.mean())

# # plt for selecting the best parameters
# plt.plot(n_range, score_lst)
# plt.xlabel('K')
# plt.ylabel('Accuracy')
# plt.show()
...
# test k = 270
clf = AdaBoostClassifier(n_estimators=270)
clf.fit(X, y)
print('training end!')
...
with open('./Results/adaboostz_full_270.csv', 'w') as f:
